...
<h1 className="text-[22px] leading-tight sm:text-4xl md:text-[3.5vw] lg:text-5xl xl:text-6xl font-normal tracking-tight text-white mb-4 break-words">
  Shreeparameshwaran{" "}
  <span className="inline-block md:block lg:inline-block">S</span>
</h1>
